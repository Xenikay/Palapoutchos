local GM = Gamemode.Create( "Menu", 1 )

GM:SetCallback( "initialize", function()
	Button.RemoveAll()
	local liste = {
		{ "Vocabulaire aléatoire", 2 },
		{ "Liste trouble mentaux", 3 }
	}

	local function CreateSectionButton( y, v )
		local Class = Button.Create( 50, y, 300, 50, v[1], 4 )
		Class.BackColor = 55
